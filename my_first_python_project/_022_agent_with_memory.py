"""
_022_agent_with_memory.py

Today's final file. One new idea, explicitly named this time: MEMORY.
You've been building it since File _019 (`self.messages`) without
...
Run with: uv run _022_agent_with_memory.py
"""
...
# is a dict with a role and content -- the exact shape from File _09's data
