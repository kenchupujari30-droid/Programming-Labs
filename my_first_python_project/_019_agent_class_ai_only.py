"""
_019_agent_class_ai_only.py

File _10's exact OOP pattern (BankAccount, Book) -- reused, unchanged in
structure, now to define an Agent. Today it only does ONE thing: hold a
conversation with its brain (File _015/_018's AI call). No tools yet.

Run with: uv run _019_agent_class_ai_only.py
"""
...
@dataclass
class Agent:
    """Same blueprint shape as File _018s Book class: a name, some state,
    ...
    def _fallback(question: str) -> str:
        from _014_fake_ai_call import FakeAIClient
...
if __name__ == "__main__":
    ...
    print("\nThis Agent can talk. It cannot yet DO anything beyond talking. File _020 gives it hands.")