...
Run with: uv run _010_oop_classes.py
"""
...
class BankAccount:
   ...
   def __init__(self,owner:str, balance: float = 0.0):
      self.owner = owner    #every instance gets own its OWN owner
...
account_1 = BankAccount(owner="Advik", balance=1000)
account_2 = BankAccount(owner="Kenchu", balance=500)
...
print(f" {account_2.owner}'s balance:{account_2.balance}")
