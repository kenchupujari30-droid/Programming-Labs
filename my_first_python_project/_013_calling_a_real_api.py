...
Run with: uv run _013_calling_a_real_api.py
"""
...
if __name__ == "__main__":
    ...
    print(convert_currency(50, "INR", "USD"))  #"ZZZ"

    print("\nThis function still knows nothing about AI. That changes starting next file.")
 

#  Parsed as a dict: {'amount': 1.0, 'base': 'USD', 'date': '2026-07-16', 'rates': {'INR': 96.35}}
