...
Run with: uv run _015_ai_call_free_and_paid.py
"""
...
QUESTION = "what is python Explain recursion with an example  Write a Python function to reverse a string               Who  developed the theory of relativity? ."
