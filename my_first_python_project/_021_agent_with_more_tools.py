"""
_021_agent_with_more_tools.py

File _20's agent, now with THREE tools instead of one: currency
conversion (real, from File _017/_018), plus weather and a calculator
(both simple, local, no network -- the point here is "more than one
tool registered," not "every tool must hit the internet").

Run with: uv run _021_agent_with_more_tools.py
"""
...
# --- Tool 1: currency conversion (unchanged from File _020) ---
...
if __name__ == "__main__":
    ...
    print("\nThree working hands now, not one. File _022 gives this agent a memory worth keeping.")